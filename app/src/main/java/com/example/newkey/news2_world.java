...
public class news2_world extends AppCompatActivity {
    ...
    private List<news2_item> loadNews2Items() {
        ...
        items2.add(new news2_item("세계 제목1", "출판사1", "시간1", "https://a-static.besthdwallpaper.com/nct-127-jaehyun-neo-zone-album-shoot-wallpaper-2560x1600-113961_7.jpg"));
        items2.add(new news2_item("세계 제목2", "출판사2", "시간2", "https://a-static.besthdwallpaper.com/nct-127-jaehyun-neo-zone-album-shoot-wallpaper-2560x1600-113961_7.jpg"));
        items2.add(new news2_item("세계 제목1", "출판사1", "시간1", "https://a-static.besthdwallpaper.com/nct-127-jaehyun-neo-zone-album-shoot-wallpaper-2560x1600-113961_7.jpg"));
        items2.add(new news2_item("세계 제목2", "출판사2", "시간2", "https://a-static.besthdwallpaper.com/nct-127-jaehyun-neo-zone-album-shoot-wallpaper-2560x1600-113961_7.jpg"));
        return items2;
    }
